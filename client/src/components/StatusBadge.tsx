...
const statusMap: Record<string, { label: string; className: string }> = {
  ...
  starting: { label: "Iniciando", className: "bg-sky-50 text-sky-700 border-sky-100" },
  connecting: { label: "Conectando", className: "bg-sky-50 text-sky-700 border-sky-100" },
  waiting_pairing: { label: "Aguardando vinculo", className: "bg-amber-50 text-amber-700 border-amber-100" },
  open: { label: "Conectado", className: "bg-emerald-50 text-emerald-600 border-emerald-100" },
  closed: { label: "Desconectado", className: "bg-rose-50 text-rose-600 border-rose-100" },
  logged_out: { label: "Sessao invalida", className: "bg-rose-50 text-rose-600 border-rose-100" },
  connection_replaced: { label: "Conexao substituida", className: "bg-rose-50 text-rose-600 border-rose-100" },
  stopped: { label: "Parado", className: "bg-zinc-100 text-zinc-600 border-zinc-200" },
